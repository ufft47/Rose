...
public:
	 ...
	 */
	const SDL_Rect& main_map_view() const;
	 ...
	 * applied to it.
	 */
	const SDL_Rect& main_map_rect2() const { return map_screenshot_ ?
		max_map_area() : main_map_rect_; }
	...
	const rect_of_hexes get_visible_hexes() const { return hexes_under_rect(main_map_view());};
