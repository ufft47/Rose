...
tpanel::tpanel(const unsigned canvas_count) 
	...
	, explicit_border_({twidget::npos, twidget::npos, twidget::npos, twidget::npos})
	, hole_left_(0)
	, hole_right_(0)
{
...
tspace4 tpanel::border_space() const
{
...
void tpanel::set_border_space(int left, int right, int top, int bottom)
{
	explicit_border_.left = left;
	explicit_border_.right = right;
	explicit_border_.top = top;
	explicit_border_.bottom = bottom;
}
