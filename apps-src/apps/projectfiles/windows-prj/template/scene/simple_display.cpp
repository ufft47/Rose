...
simple_display::simple_display(simple_controller& controller, unit_map& units, CVideo& video, const tmap& map)
	: display(game_config::tile_square, &controller, video, &map, gui2::tsimple_scene::NUM_REPORTS)
