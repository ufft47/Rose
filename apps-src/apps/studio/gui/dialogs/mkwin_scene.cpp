...
void tmkwin_scene::app_pre_theme_show()
{
	...
	widget->set_blits(gui2::tformula_blit("buttons/select.png", null_str, null_str, "(width)", "(height)"));
	...
	widget->set_blits(gui2::tformula_blit("buttons/grid.png", null_str, null_str, "(width)", "(height)"));
	click_generic_handler(*widget, null_str);
