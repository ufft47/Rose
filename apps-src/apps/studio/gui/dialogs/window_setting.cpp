...
void twindow_setting::append_float_widget(twindow& window)
{
	...
	const std::string default_float_widget_id = "float_untitled";
...
/*
	{
		patch_bar_->set_item_visible(float_widget_at_ + 1, true);
		int ii = 0;
		return;
	}
*/
...
/*
	{
		patch_bar_->erase_item(float_widget_at_ - 2, false);
		int ii = 0;
		return;
	}
*/
